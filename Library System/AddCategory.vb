...
Public Class AddCategory
    ...
    Private Sub TextBox1_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txt_days.KeyPress
    ...
    Private Sub TextBox1_TextChanged(sender As Object, e As EventArgs) Handles txt_days.TextChanged
