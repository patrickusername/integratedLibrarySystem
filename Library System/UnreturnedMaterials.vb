...
Public Class UnreturnedMaterials
    Private Sub UnreturnedMaterials_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'Me.WindowState = FormWindowState.Maximized
        DataGridView1.BackgroundColor = System.Drawing.SystemColors.Control
        Dim conn As New MySqlConnection(connString)
        Dim dt As New DataTable
        Dim dat As New MySqlDataAdapter("Select * From tbl_borrowreturnnonprinted WHERE Name='" & TeacherMainForm.lbl_name.Text & "'", conn)
        dt.Clear()
        dat.Fill(dt)
