...
Public Class LostBook
    Private Sub bind_data()
        ...
        conn.Open()
        Dim cmd As New MySqlCommand("Select BookNumber,ISBN,Title,Author,Category,Name,DatetoReturn from tbl_lostbooks", conn)
    ...
    Private Sub btn_generate_Click(sender As Object, e As EventArgs) Handles btn_generate.Click
        ...
        Dim cmd As New MySqlCommand("Select BookNumber,ISBN,Title,Author,Category,Name,DatetoReturn from tbl_lostbooks where datetoreturn between '" & dt1.Value.ToString("MM/dd/yyyy - hh:mm tt") & "' and '" & dt2.Value.ToString("MM/dd/yyyy - hh:mm tt") & "'", conn)
        Dim d As New MySqlDataAdapter
        d.SelectCommand = cmd
        Dim dt As New DataTable
        dt.Clear()
