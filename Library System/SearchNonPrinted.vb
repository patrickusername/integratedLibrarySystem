...
Public Class SearchNonPrinted
    ...
    Private Sub txt_isbn1_TextChanged(sender As Object, e As EventArgs) Handles txt_isbn1.TextChanged
        Dim searchque As String = "Select * from tbl_nonprinted Where concat (MaterialNumber, MaterialName, Status, ImagePath)  like '%" & txt_isbn1.Text & "%'"
