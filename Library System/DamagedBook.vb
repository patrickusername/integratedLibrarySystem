...
Public Class DamagedBook
    Private Sub bind_data()
        ...
        conn.Open()
        Dim cmd As New MySqlCommand("Select BookNumber,ISBN,Title,Author,Category,Name,DateReturned from tbl_damagedbooks", conn)
    ...
    End Sub
    Private Sub DamagedBook_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btn_generate_Click_1(sender As Object, e As EventArgs) Handles btn_generate.Click
        ...
        Dim cmd As New MySqlCommand("Select BookNumber,ISBN,Title,Author,Category,Name,DateReturned from tbl_damagedbooks where datereturned between '" & dt1.Value.ToString("MM/dd/yyyy - hh:mm tt") & "' and '" & dt2.Value.ToString("MM/dd/yyyy - hh:mm tt") & "'", conn)
        Dim d As New MySqlDataAdapter
        d.SelectCommand = cmd
        Dim dt As New DataTable
        dt.Clear()
        ...
        DamagedBookReport.CrystalReportViewer1.ReportSource = reportDocument
        DamagedBookReport.ShowDialog()
        DamagedBookReport.Dispose()
    End Sub
    ...
    Private Sub txt_search_Click(sender As Object, e As EventArgs) Handles txt_search.Click
        ...
        Dim cmd As New MySqlCommand("Select BookNumber,ISBN,Title,Author,Category,Name,DateReturned from tbl_damagedbooks where datereturned between '" & dt1.Value.ToString("dd/MM/yyyy - hh:mm tt") & "' and '" & dt2.Value.ToString("dd/MM/yyyy - hh:mm tt") & "'", conn)
        Dim d As New MySqlDataAdapter
        d.SelectCommand = cmd
        Dim dt As New DataTable
        dt.Clear()
