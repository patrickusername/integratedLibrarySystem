...
Public Class SearchBook2
    ...
    Private Sub SearchBook2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        da.Fill(dt)
    End Sub
    Private Sub btn_cleaar11_Click_1(sender As Object, e As EventArgs) Handles btn_cleaar11.Click
        txt_isbn1.Clear()
        DataGridView1.ClearSelection()
        DataGridView1.Sort(DataGridView1.Columns(0), ListSortDirection.Descending)
        txt_isbn1.Focus()
    ...
    Private Sub txt_isbn1_TextChanged_1(sender As Object, e As EventArgs) Handles txt_isbn1.TextChanged
