...
Public Class OverdueNonPrinted
    Private Sub bind_data()
        ...
        conn.Open()
        Dim cmd As New MySqlCommand("Select * from tbl_overduenonprinted", conn)
    ...
    Private Sub btn_generate_Click(sender As Object, e As EventArgs) Handles btn_generate.Click
        ...
        Dim cmd As New MySqlCommand("Select * From tbl_overduenonprinted where datereturned between '" + dt1.Value.ToString("dd/MM/yyyy") + "' and '" + dt2.Value.ToString("dd/MM/yyyy") + "'", conn)
        Dim d As New MySqlDataAdapter
        d.SelectCommand = cmd
        Dim dt As New DataTable
        dt.Clear()
